...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css"  href="{{asset('assets/Css/identify.css')}}" />
		...
		<link rel="stylesheet" type="text/css" href="{{asset('assets/Css/control_index.css')}}" />
		<script type="text/javascript" src="{{asset('assets/Js/jquery-1.7.2.min.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/Js/layer/layer.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/Js/haidao.offcial.general.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/Js/select.js')}}"></script>
		<script type="text/javascript" src="{{asset('assets/Js/haidao.validate.js')}}"></script>
		...
		@section('header')<!--导航栏-->
			<div class="topbar-console">
				<div class="tobar-head fl">
					...
					<span><img src="{{asset(('assets/Images/logo.png'))}}" width="20" height="20"/></span>
					</a>
				...
				<div class="sidebar-content">
					<div class="sidebar-nav">
						<div class="sidebar-title">
							<a href="#">
								...
								<span class="text-normal">活动管理</span>
							</a>
						</div>
					...
					<div class="sidebar-nav">
						<div class="sidebar-title">
							<a href="#">
								<span class="icon"><b class="fl icon-arrow-down"></b></span>
								<span class="text-normal">大师管理</span>
							</a>
						</div>
						<ul class="sidebar-trans">
							<li>
								<a href="{{url('Master/index')}}">
									<b class="sidebar-icon"></b>
									<span class="text-normal">大师管理</span>
								</a>
							</li>
							<li>
								<a href="{{url('Master/video')}}">
									<b class="sidebar-icon"></b>
									<span class="text-normal">大师视频管理</span>
								</a>
							</li>
						</ul>
					</div>
