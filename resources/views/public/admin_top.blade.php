...
<html lang="en">
	...
	<body class="no-skin">
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a href="index.html" class="navbar-brand">
						<small>
							<img src="{{asset('asset/avatars/logo.png')}}" alt="" />
						</small>
					</a>
				</div>
				...
				<ul class="nav nav-list">
					...
					<li class="">
						...
						<ul class="submenu">
							...
							<li class="">
								<a href="{{url('Admin/admin_addlist')}}">
									<i class="menu-icon fa fa-caret-right"></i>
									添加管理员
								</a>
		...
		<script type="text/javascript">
			window.jQuery || document.write("<script src='{{asset('asset/js/jquery.min.js')}}'>"+"<"+"/script>");
		</script>

		<script type="text/javascript">
			if('ontouchstart' in document.documentElement)
			{
				document.write("<script src='{{asset('asset/js/jquery.mobile.custom.min.js')}}'>"+"</script>");
			};
		</script>
